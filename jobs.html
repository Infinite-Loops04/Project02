...
<html lang="en">
    ...
    <body>
        <header id="header">
           <img id="logo" src="images/clouldspire_logo.png" alt="CloudSpire Logo">
        ...
        <!-- The following section "Welcome to CloudSpire Technologies Careers" was generated by GitHub Copilot on 9 April 2025. -->
        <main id="welcome">
            ...
            <h1>Welcome to CloudSpire Technologies Careers</h1>
                ...
                <p>Our team is made up of talented individuals who are passionate about technology and dedicated to delivering exceptional results for our clients. We offer a range of career opportunities in various fields, including Ethical Hacker,Cybersercurity Analyst, and more.</p>
        ...
        <!-- The following section "Why Work with Us?" was generated by GitHub Copilot on 9 April 2025. -->
        <section>
            <aside class="jobsimage">
        ...
        <!-- The following section "Join Our Team" was generated by GitHub Copilot on 9 April 2025. -->
        ...
        <section id="join">
           ...
           <h2>Current Openings</h2>
            ...
            <!-- The following job descriptions for job title cybersecurity specialists was generated using ChatGPT on 6 April 2025. 
            I chose this job type because it aligns with my career goals and aspirations. 
            I also discussed with my teammates to see if they wanted to add anything, but they agreed with my choice. 
            This job type reflects my dream of working in this field. --> 
        <section>
            <h2>Job Descriptions</h2>
            <p>Below are the detailed job descriptions for our current openings:</p>
             <!-- The following job description for Cybersecurity Analyst was generated using ChatGPT on 6 April 2025. 
         I chose this job type because it aligns with my career goals and interests in cybersecurity. -->
         <aside class="jobsimage">
     ...
     <hr>
      <!-- The following footer section was manually created to display copyright information for CloudSpire Technologies. -->
        <footer id="footer">
            <p>&copy; 2023 CloudSpire Technologies. All rights reserved.</p>
        </footer>
